...
/**
 * Creates layers and adds them to the main window.
 *
 * @param window he window to load
 */
...
/**
 * Destroys all layers in the main window.
 *
 * @param window the window to unload.
 */
...
/**
 * App entry point.
 * Function app_event_loop() will block until the app is ready to exit.
 *
 * @return the exit status, possibly not used
 */
int main(void) {
    init();
    app_event_loop();
